...
// let tinymceFullScreen = document.getElementsByClassName('mce-tinymce mce-container mce-panel');
// if(tinymceFullScreen.classList.contains('active')){
