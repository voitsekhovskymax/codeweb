        ...
        methods: {
                    ...
                    tinymce.init({
                        ...
                        setup: function (editor) {
                            editor.on('init', function (e) {
                                vm.spinShow = false;
                                tinymce.get('articleEditor').setContent(vm.article.content);
                            });
                            // editor.on('FullscreenStateChanged', function () {
                            //     console.log('FullscreenStateChanged event fired.');
                            //     let tinymceFullScreen = document.getElementsByClassName('mce-tinymce');
                            //     if ( document.getElementsByClassName('mce-tinymce').classList.contains('mce-fullscreen')) {
                            //         document.getElementsByClassName('single-page-con').style.zIndex = '100';
                            //     }
                            //     else{
                            //         document.getElementsByClassName('single-page-con').style.zIndex = '1';
                            //     }
                            // });
                        },
            ...
            handlePublish() {
                if (this.canPublish()) {
                    ...
                    this.axios.patch('/api/posts/' + this.$route.params.id, this.article).then((response) => {
                        if (response.data == 0) {
                            this.$Notice.warning({
                                title: 'Внимание!',
                            ...
                            this.$Notice.success({
                                title: 'Успешно!',
                                desc: 'Статья 《' + this.article.title + '》успешно опубликована!'
                            });
                        }
                    });
